...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'cmd_run', fields ['ip']
        db.delete_unique(u'app_cmd_run', ['ip'])


    def backwards(self, orm):
        # Adding unique constraint on 'cmd_run', fields ['ip']
        db.create_unique(u'app_cmd_run', ['ip'])
