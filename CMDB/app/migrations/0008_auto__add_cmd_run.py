...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'cmd_run'
        db.create_table(u'app_cmd_run', (
            ...
            ('track_mark', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'app', ['cmd_run'])


    def backwards(self, orm):
        # Deleting model 'cmd_run'
        db.delete_table(u'app_cmd_run')
